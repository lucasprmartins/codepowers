...
**Documentação:**
- Escreva e salve a especificação validada em `docs/spec/AAAA-MM-DD-<tópico>.md`
...
- Se sim: Use a habilidade `codepowers:write-plan` para criar um plano de implementação detalhado
